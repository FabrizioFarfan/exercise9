public class Main {
    ...
    private static void exercise3() {
        ...
        if(!isTestRetry){
        if (ourTestScore>= 9*maxTestScore/10){
            System.out.println("A");
        } else if (ourTestScore>= 8*maxTestScore/10) {
            System.out.println("B");
        }else if (ourTestScore>= 7*maxTestScore/10) {
            System.out.println("C");
        }else if (ourTestScore>= 6*maxTestScore/10) {
            System.out.println("D");
        }else {
            System.out.println("F");
        }
        } else {
            if (ourTestScore>= 7*maxTestScore/10) {
                System.out.println("C");
            }else if (ourTestScore>= 6*maxTestScore/10) {
                System.out.println("D");
            }else {
